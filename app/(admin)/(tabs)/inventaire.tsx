...
const FEATURES = [
  ...
  "Scan et saisie rapide des articles",
    ...
    <View style={[styles.container, { paddingTop: topPad }]}>
      <View style={styles.content}>
        ...
        <Text style={styles.desc}>
          Réalisez vos inventaires périodiques, suivez les écarts et gardez un historique complet de vos comptages. Ce module sera disponible dans une prochaine mise à jour.
        </Text>
...
const getStyles = (theme: ThemeColors) => StyleSheet.create({
  ...
  badge: { fontSize: 14, fontFamily: "Inter_600SemiBold", color: "#14B8A6" },
