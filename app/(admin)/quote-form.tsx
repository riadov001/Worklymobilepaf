      ...
      <ScrollView contentContainerStyle={[styles.scroll, { paddingBottom: bottomPad }]} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.chipRow}>
          {["0", "5.5", "10", "20"].map(rate => (
            <Pressable key={rate} style={[styles.chip, taxRate === rate && { backgroundColor: theme.primary + "20", borderColor: theme.primary }]} onPress={() => setTaxRate(rate)}>
        ...
        <View style={[styles.input, { justifyContent: "center" }]}>
          <Text style={{ fontSize: 16, fontFamily: "Inter_700Bold", color: theme.primary }}>{quoteAmount} €</Text>
        </View>
        ...
        <TextInput style={[styles.input, { height: 100, textAlignVertical: "top", paddingTop: 12 }]} value={notes} onChangeText={setNotes} placeholder="Notes internes..." placeholderTextColor={theme.textTertiary} multiline />
