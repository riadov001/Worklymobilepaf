...
export default function ModuleInventaireScreen() {
  ...
  return (
    <View style={[styles.container, { paddingTop: topPad }]}>
      ...
      <View style={styles.content}>
        <View style={[styles.iconWrap, { backgroundColor: "#14B8A620" }]}>
          <Ionicons name="clipboard-outline" size={56} color="#14B8A6" />
        </View>
        <Text style={styles.title}>Module Inventaire</Text>
        <Text style={styles.subtitle}>Bientôt disponible</Text>
        <Text style={styles.desc}>
          Effectuez vos inventaires, suivez les mouvements de marchandises et optimisez votre gestion des actifs. Ce module sera disponible dans une prochaine mise à jour.
        </Text>
        <View style={styles.featureList}>
          {["Inventaires périodiques assistés", "Suivi des entrées et sorties", "Gestion des emplacements", "Export et rapports détaillés"].map((f, i) => (
...
const getStyles = (theme: ThemeColors) => StyleSheet.create({
  ...
  subtitle: { fontSize: 14, fontFamily: "Inter_600SemiBold", color: "#14B8A6" },
