...
export default function ModuleStockScreen() {
  ...
  return (
    <View style={[styles.container, { paddingTop: topPad }]}>
      ...
      <View style={styles.content}>
        ...
        <Text style={styles.title}>Module Stock</Text>
        ...
        <View style={styles.featureList}>
          {["Suivi des niveaux de stock en temps réel", "Alertes de réapprovisionnement automatiques", "Gestion des fournisseurs", "Rapports d'inventaire"].map((f, i) => (
...
const getStyles = (theme: ThemeColors) => StyleSheet.create({
  ...
  subtitle: { fontSize: 14, fontFamily: "Inter_600SemiBold", color: "#F59E0B" },
