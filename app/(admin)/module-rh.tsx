...
export default function ModuleRHScreen() {
  ...
  return (
    <View style={[styles.container, { paddingTop: topPad }]}>
      ...
      <View style={styles.content}>
        ...
        <Text style={styles.title}>Module RH</Text>
        <Text style={styles.subtitle}>Bientôt disponible</Text>
        <Text style={styles.desc}>
          Gérez vos équipes, planifiez les horaires et suivez les congés de votre personnel. Ce module sera disponible dans une prochaine mise à jour.
        </Text>
        <View style={styles.featureList}>
          {["Gestion des fiches employés", "Planification des horaires et rotations", "Suivi des congés et absences", "Rapports RH et tableaux de bord"].map((f, i) => (
...
const getStyles = (theme: ThemeColors) => StyleSheet.create({
  ...
  subtitle: { fontSize: 14, fontFamily: "Inter_600SemiBold", color: "#EC4899" },
